...
window.AppComponents.GNB = ({ 
    ...
    return (
        <nav className="bg-white/90 backdrop-blur-md border-b-2 border-slate-100 sticky top-0 z-50">
                    ...
                    <div className="flex justify-between h-20 items-center">
                        ...
                        <div className="flex items-center gap-3 shrink-0 cursor-pointer group relative" onClick={() => handleNavClick('홈')}>
                            <div className="relative">
                                {!logoError ? (
                                    <img src="nexon-skills.webp" alt="NEXON Skills" className="w-10 h-10 object-contain drop-shadow-sm transition-transform]" onError={() => setLogoError(true)} />
                                ) : (
                            ...
                            <span className="text-2xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-slate-900 to-slate-700 transition-all">NEXON Skills</span>
            ...
            {/* Mobile Menu */}
            {isMenuOpen && (
                <div className="lg:hidden absolute top-20 left-0 w-full bg-white border-b-2 border-slate-200 shadow-2xl z-40 rounded-b-3xl overflow-hidden">
